...
{{- printf "jdbc:mysql://%s:%s/%s?characterEncoding=UTF-8" (include "pinpoint-web.mysql.host" .) (include "pinpoint-web.mysql.port" .) (include "pinpoint-web.mysql.database" .) }}
{{- end }}
...
{{- default 3306 .Values.mysql.port }}
{{- end }}
